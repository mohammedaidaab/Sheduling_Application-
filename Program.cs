...
.GetConnectionString("DefaultConnection")).UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking).EnableSensitiveDataLogging());
...
app.MapControllerRoute(
    name: "default",
    pattern: "{controller=Calender}/{action=Index}/{id?}");
